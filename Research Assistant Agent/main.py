...
<div style='border:1px solid #ccc; border-radius:8px; padding:10px; margin:8px 0; background:#fff;'>
  ...
  <div style='white-space:pre-wrap;'>{html.escape(prompt)}</div>
...
{html.escape(format_history(execution_history[-2:-1]))}
  </pre>

  <div style='font-weight:bold; color:#f59e0b; margin-top:8px;'>🧩 Your next task</div>
  <div style='white-space:pre-wrap;'>{html.escape(actual_step_description)}</div>
